...
I18n.available_locales = %i[en ru it de fr es pt-br nl hy uk hi tr ro cs sv pl bg fa el ko en-au]
...
Rails.configuration.admin_locales = %i[en cs es fr it ro ru uk de en-au]
